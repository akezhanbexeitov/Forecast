...
<template>
    <section v-if="weatherInfo?.weather" class="coordinates">
        <div class="compass">
            <img class="compass-image" src="/src/assets/img/compass.png" alt="Compass">
        </div>
        ...
        <!-- <div>
            <div  v-if="weatherInfo?.weather" class="block-bottom-inner">
